...
# View logs
docker-compose -f docker-compose.production.yml logs -f neurograph-api
...
docker-compose logs neurograph-api | grep ERROR

# Export logs
docker-compose logs --no-color neurograph-api > api-logs.txt
```
...
# Restart service
docker-compose restart neurograph-api
```
